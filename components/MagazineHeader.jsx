        ...
        {!isSearchOpen ? (
          <>
            ...
            <nav className={`main-nav ${isMobileMenuOpen ? 'active' : ''}`}>
              ...
              <Link href='/posts' className='nav-link' onClick={() => setIsMobileMenuOpen(false)}>
                <span className='nav-text'>BLOG</span>
                <span className='nav-underline'></span>
              </Link>
              <Link href='/photography' className='nav-link' onClick={() => setIsMobileMenuOpen(false)}>
                <span className='nav-text'>PHOTOGRAPHY</span>
                <span className='nav-underline'></span>
              </Link>
              <Link href='/lab' className='nav-link' onClick={() => setIsMobileMenuOpen(false)}>
